...
// EXP综合实验一0512Set.cpp : CEXP综合实验一0512Set 类的实现
//
...
// 代码生成在 2020年5月19日, 13:17

IMPLEMENT_DYNAMIC(CEXP综合实验一0512Set, CRecordset)

CEXP综合实验一0512Set::CEXP综合实验一0512Set(CDatabase* pdb)
	: CRecordset(pdb)
{
	column1 = L"";
	column2 = L"";
...
// 储为其他格式或使用其他的用户身份验证。
CString CEXP综合实验一0512Set::GetDefaultConnect()
{
...
CString CEXP综合实验一0512Set::GetDefaultSQL()
{
	return _T("[Sheet1$]");
}

void CEXP综合实验一0512Set::DoFieldExchange(CFieldExchange* pFX)
{
...
#ifdef _DEBUG
void CEXP综合实验一0512Set::AssertValid() const
{
	CRecordset::AssertValid();
}

void CEXP综合实验一0512Set::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
